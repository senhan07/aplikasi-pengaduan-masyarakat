...
<body>
  <div class="sidebar close">
    <div class="logo-details">
      ...
      <span class="logo_name">Menu Ketua RT</span>
    </div>
    <ul class="nav-links">
      <li>
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="index.php?p=adm">Petugas</a></li>
      ...
      <li>
        <a href="index.php?p=respon">
          ...
          <span class="link_name">Tanggapan</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="index.php?p=respon">Tanggapan</a></li>
        </ul>
      </li>
      <!-- New menu item for Kritik dan Saran -->
      <li>
        <a href="index.php?p=kritik_saran">
          <i class='bx bx-message-square-detail'></i>
          <span class="link_name">Komentar</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="index.php?p=kritik_saran">Komentar</a></li>
        </ul>
      </li>
      <li>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <div class="home-content-print">
        ...
        } elseif(@$_GET['p']=="kritik_saran"){
          include_once 'kritik_saran.php';
        ...
        } elseif(@$_GET['p']=="chat"){ // Add condition to include chat.php
